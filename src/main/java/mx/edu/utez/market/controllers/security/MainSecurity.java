...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests().antMatchers("/api-market/auth/**", "/api-market/contact/**")
                .permitAll().antMatchers("/api-market/category/*").permitAll()
                ...
                .anyRequest().authenticated().and().exceptionHandling().authenticationEntryPoint(entryPoint).and().sessionManagement()
