...
public class JwtProvider {
    ...
    public String generateToken(Authentication authentication){
        ...
        return Jwts.builder().setSubject(authUser.getUsername()).setIssuedAt(new Date()).setExpiration(new Date(new Date().getTime() + expitation * 1000L)).signWith(SignatureAlgorithm.HS512, secret).compact();
    }
